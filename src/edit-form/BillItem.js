                    ...
                    <ModalHeader >Bill details</ModalHeader>
                        <ModalBody>
                            ...
                            <Preview id={'jsx-template'} >
                              <h5 className="d-inline-block">Bill Date - </h5><span >{moment(bill.date).format('MMMM Do YYYY')}</span><br />
                     ...
                     <ModalFooter>
                       <button className="btn btn-outline-success" onClick={()=>print(`${findCustomer(bill.customer)} - ${moment(bill.date).format('MMMM Do YYYY')} invoice`, 'jsx-template')}>Download Bill</button>
